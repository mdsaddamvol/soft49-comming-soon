...
// import LandingPageTf from "./pages/DemoTf";
// import LandingPageCm from "./pages/DemoCm";
	...
	return (
		<Router>
			<Switch>
				...
				<Route
					exact
					path={process.env.PUBLIC_URL + "/tf"}
					component={LandingPageTf}
				/>
				<Route
					exact
					path={process.env.PUBLIC_URL + "/cm"}
					component={LandingPageCm}
				/>
				<Route
